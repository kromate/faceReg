<template>
	<form class="grid place-items-center place-content-center mt-24 w-full" 	@submit.prevent="saveCapturedUser">
		<img :src="face.img" alt="userFace"  class="rounded-full w-72 h-72 border border-indigo-600">
